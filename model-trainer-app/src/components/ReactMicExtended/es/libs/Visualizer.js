...
var Visualizer = {
  visualizeSineWave: function visualizeSineWave(
    canvasCtx,
    canvas,
    width,
    height,
  ...
  visualizeFrequencyBars: function visualizeFrequencyBars(
    canvasCtx,
    canvas,
    width,
    height,
  ...
  visualizeFrequencyCircles: function visualizeFrequencyCircles(
    canvasCtx,
    canvas,
    width,
    height,
